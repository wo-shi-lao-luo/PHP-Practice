 ...
 <body>
 	...
 	<p>
		...
		<form method="post">
			...
			<div id='edu'>
				Education: 
				<input type="button" name="+" value="+" id="edup">
			</div>
			<div id='pos'>
				Position: <button id="posp">+</button><br>
			</div>
 	...
 	<script type="text/javascript">
 		...
 		$(document).ready(function() {
 			window.console && console.log('Ducument ready');
			...
			$('#edup').click(function(){
	 			...
	 			pos = epos.pop();
	 			$('#edu').append('<p id=\'pos'+pos+'\'>Year: <input type="text" name="eyear'+pos+'">'+' '+'<input type="button" value="-" onclick="$(\'#pos'+pos+'\').remove(); count--; poss.push('+pos+'); return false;"><br>Institution: <input type="text" class="school" name="edesc'+pos+'""></p>');
	 			count++;
	 			pos++; 					
				})
